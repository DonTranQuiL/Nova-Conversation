...
async def test_async_process_text_stream_success(mock_get_chat_log, mock_get_session, hass: HomeAssistant):
    ...
    # Returns an instantiated async generator matching 'async for' loop design
    ...
    mock_log.async_add_delta_content_stream = MagicMock(side_effect=mock_add_delta_stream)
